...
if __name__ == '__main__':
    ...
    """ 
    Usage: 
        goldendict_pronunciation.py [word] [sound_dir] 

        python /media/xuananh/data/github/python-note/goldendict_pronunciation.py %GDWORD% /media/xuananh/data/.goldendict/Webster-Voice-Package-English

    example:
        python /media/xuananh/data/github/python-note/goldendict_pronunciation.py test /media/xuananh/data/.goldendict/Webster-Voice-Package-English
